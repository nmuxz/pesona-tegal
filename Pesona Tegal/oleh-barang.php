...
$query = "SELECT * FROM oleh_oleh WHERE subkategori = 'Barang'";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/oleh-barang.css"> <!-- Link ke file CSS -->
</head>
<body data-logged-in="<?= $isLoggedIn ? 'true' : 'false' ?>">
    ...
    <section class="wisata-list">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>Tidak ada oleh-oleh barang yang tersedia.</p>";
        }
