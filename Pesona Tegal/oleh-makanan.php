...
$query = "SELECT * FROM oleh_oleh WHERE subkategori = 'Makanan'";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/oleh-makanan.css"> <!-- Link ke file CSS -->
</head>
    ...
    <section class="wisata-list">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                $oleh_oleh_id = $row['id'];
                $query_rating = "SELECT AVG(rating) AS avg_rating FROM rating WHERE id_item = $oleh_oleh_id AND kategori = 'oleh_oleh'";
                ...
                echo '
                <div class="card">
                    <img src="' . $row['foto_utama'] . '" alt="' . $row['nama_oleh_oleh'] . '">
                    <div class="card-body">
                        <h3>' . $row['nama_oleh_oleh'] . '</h3>
            ...
            echo "<p>Tidak ada oleh-oleh makanan yang tersedia.</p>";
        }
