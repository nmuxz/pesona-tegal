...
$query = "SELECT * FROM wisata WHERE subkategori = 'Wisata Alam'";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/wisata-alam.css"> <!-- Link ke file CSS -->
</head>
...
<body data-logged-in="<?= $isLoggedIn ? 'true' : 'false' ?>">
    ...
    <section class="wisata-list">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>Tidak ada wisata alam yang tersedia.</p>";
        }
