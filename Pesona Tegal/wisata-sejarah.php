...
$query = "SELECT * FROM wisata WHERE subkategori = 'Wisata Sejarah'";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/wisata-sejarah.css"> <!-- Link ke file CSS -->
</head>
...
<body data-logged-in="<?= $isLoggedIn ? 'true' : 'false' ?>">
    ...
    <!-- Menampilkan Data Wisata sejarah -->
    <section class="wisata-list">
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<p>Tidak ada wisata sejarah yang tersedia.</p>";
        }
