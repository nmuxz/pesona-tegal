...
$query = "SELECT * FROM kuliner WHERE subkategori = 'Cafe'";
...
<head>
    ...
    <link rel="stylesheet" href="assets/css/kuliner-cafe.css"> <!-- Link ke file CSS -->
    ...
    <section class="wisata-list">
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '
                <div class="card">
                    <img src="' . $row['foto_utama'] . '" alt="' . $row['nama_kuliner'] . '">
                    <div class="card-body">
            ...
            echo "<p>Tidak kuliner cafe yang tersedia.</p>";
        }
