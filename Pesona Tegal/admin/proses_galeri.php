...
$db_dir = "uploads/galeri/$kategori/" . strtolower(str_replace(' ', '_', $subkategori)) . "/";
    $target_dir = "../" . $db_dir;
...
$target_file = $target_dir . basename($foto['name']);
    $db_file = $db_dir . basename($foto['name']);
...
if (move_uploaded_file($foto['tmp_name'], $target_file)) {
    ...
    $stmt->bind_param('isss', $id_kategori, $kategori, $db_file, $status);
